---
title: "DALP Overview"
description: "Introduces the DALP as a unified control plane spanning issuance, compliance, custody, settlement, and servicing."
icon: "Workflow"
---
...
## 2.1 What the DALP is (and isn't)
...
## 2.4 Data & object model (primitives that matter)
...
## 2.5 Compliance as code (ERC-3643-style)
...
## 2.6 Custody and key governance
...
## 2.7 Lifecycle operations & monitoring
...
## 2.8 Settlement & interoperability: T+0 is the baseline
...
## 2.9 Deployment, white-label, and enterprise identity
...
## 2.10 UX/DX: speed for humans and for code
...
## 2.11 Governance, legal, and audit
...
## 2.12 How the DALP changes the game (institution, developer, investor)
...
## 2.13 Proof: what "good" looks like in numbers
...
## 2.14 Why SettleMint's DALP is the category
