---
title: "Settlement & Interoperability: T+0 Is the Baseline"
...
**Conclusion:** Settlement risk is optional. We remove it. The Asset Tokenization Kit treats T+0 as the default by shipping ready-to-use atomic settlement patterns, the Cross-Value Proposition (XvP) addon stack, and the payment-rail integrations required to run them.
...
## 4.1 Atomic DvP (how we actually do it)
...
## 4.2 Payment networks and ISO 20022 alignment
...
## 4.6 Failure modes and defenses
