...
description: "ATK moves assets from term sheet to production with templated compliance, real-time ownership registries, and programmable lifecycle controls."
---
...
flowchart LR
  ...
  factory --> indexer["Subgraph + ownership registry"]
