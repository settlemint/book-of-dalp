...
Gravity for all of this sits in APIs. Everything you can do in the UI is also exposed through ORPC procedures, REST, and GraphQL, so banks embed issuance flows inside existing portals under their own branding.
