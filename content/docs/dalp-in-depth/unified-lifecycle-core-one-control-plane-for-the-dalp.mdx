...
3. Identity teams onboard investors through the shared OpenAPI-documented REST APIs. Claims flow into the identity registry and synchronize across offerings with no duplicate KYC.
4. Custody operations pre-stage HSM-backed wallet tiers and policy thresholds directly in the DALP's custody services.
